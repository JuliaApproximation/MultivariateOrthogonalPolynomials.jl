...
@testset "Dirichlet restriction" begin
    ...
    f=Fun((x,y)->exp(x-0.12*cos(y)),KoornwinderTriangle(0,0,0,d))
    C=Conversion(DirichletTriangle{1,1,1}(d),DirichletTriangle{1,1,0}(d),DirichletTriangle{1,0,0}(d),KoornwinderTriangle(0,0,0,d))
    u=C\f
